            ...
            <div class="container">
                <div class="row mt-5 d-flex justify-content-between profil">
                    <div class="col-sm-5 align-self-center">
                        <h4>Profil</h4>
                        <p>
                            Cv Hidro Sinergi Utama adalah Perusahaan ketahanan pangan mandiri dengan konsep holding company. Bersinergi dengan lebih dari 1000 petani dan pelaku UMKM berbasis komunitas di 20 kab/kota di Pulau Sumatera. Mengembangkan hasil sayur fresh dan olahan sayur serta potensi agrowisata dan eduwisata.
                            <br>
                            Kami memberikan solusi sayur sehat masyarakat dengan jargon <b>“Fresh From Farm To The Table”</b> di 20 Kab/Kota dengan Me-Replikasi Bisnis ini di setiap Mitra Binaan. Sayur sehat fresh berkualitas dari kebun langsung ke meja makan Konsumen.
                            <br>
                            <br>
                            Visi: Menjadi Perusahaan Ketahanan Pangan mandiri dengan Konsep Ekonomi Kerakyatan.
                            <br>
                            Misi: Sebagai Perusahaan Pertanian Modern Yang Mempelopori Ekonomi Kerakyatan untuk Pembangunan Ekonomi masyarakat yang sangat cepat pertumbuhannya dan sangat gampang di replikasi.
                        </p>
                    </div>
                    ...
                    <div class="col-sm-5">
                        <div class="row">
                            <div class="col-sm-12 d-flex justify-content-end">
                                <img src="{{ asset('assets/images/profil1.png') }}" alt="profil1" class="w-100">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row mt-5 d-flex justify-content-between profil">
                    <div class="col-sm-5">
                        <div class="row">
                            <div class="col-sm-12 d-flex justify-content-end">
                                <img src="{{ asset('assets/images/profil2.png') }}" alt="profil2" class="w-100">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-2"></div>
                    <div class="col-sm-5 align-self-center">
                        <p>
                            <b>Greenfills Farm Hidroponik</b> adalah kebun binaan sekaligus kebun edukasi mengenai budidaya sayuran hidroponik yang berada dibawah naungan CV. HIDRO SINERGI UTAMA yang berada di Jl. Pasar 1 Tambak Rejo, Kecamatan Percut Sei Tuan, Kabupaten Deli Serdang, Provinsi Sumatera Utara. Dimana, pada Greenfills Farm dilakukan kegiatan-kegiatan pelatihan dan pengenalan budidaya hidroponik dengan beberapa sistem sesuai dengan fungsinya sebagai kebun edukasi.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container layanan">
                ...
                <div class="row mt-5 d-flex justify-content-between">
                    <div class="col-sm-5 align-self-center">
                        <div class="row">
                            <div class="col-sm-12  py-3">
                                <div class="row">
                                    <div class="col-sm-2">
                                        <img src="{{ asset('assets/images/produk.png') }}" alt="produk" class="w-100">
                                    </div>
                                    <div class="col-sm-10 icon-text align-self-center">
                                        <p>60% sayuran sehat dan 40% olahan sayur berupa Mie Sehat serta Perlengkapan & Alat Hidroponik.</p>
                                    </div>
                                </div>
                                <div class="row mt-5">
                                    <div class="col-sm-2">
                                        <img src="{{ asset('assets/images/jasa.png') }}" alt="jasa" class="w-100">
                                    </div>
                                    <div class="col-sm-10 icon-text align-self-center">
                                        <p>Pelatihan & Pemberdayaan kerjasama kementrian, BUMN, BUMD, Swasta, Kontruksi GreenHouse Hidroponik, Pengelolaan Lahan.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <img src="{{ asset('assets/images/produkjasa2.png') }}" alt="produkjasa2" class="w-100 h-100">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-12 d-flex justify-content-end">
                                <img src="{{ asset('assets/images/produkjasa1.png') }}" alt="produkjasa1" class="w-100 h-100">
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="mt-5 py-5 pb-5">
                <div class="vektor1">
                    <div class="row">
                        <div class="col-sm-12">
                            <img src="{{ asset('assets/images/vektor1.png') }}" alt="vektor1" class="w-100 h-100">
                        </div>
                    </div>
                </div>
                ...
                <div class="vektor2">
                    <div class="row">
                        <div class="col-sm-12">
                            <img src="{{ asset('assets/images/vektor2.png') }}" alt="vektor2" class="w-100 h-100">
                        </div>
                    </div>
                </div>
            </div>
